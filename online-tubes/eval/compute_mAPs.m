...
actions = {'Calling', 'Carrying', 'Drinking', '"Hand', 'Hugging', 'Lying', 'Pushing/Pulling', 'Reading', 'Running', 'Sitting', 'Standing', 'Walking'};
...
annot = load('../finalAnnotsMultiTubes18.mat'); new = 1;
for iou_th = [0.2,0.5:0.05:0.95]
